...
```bash
➜ git clone https://github.com/mprambadi/golang-echo-realworld-example-app.git
```

Or simply use the following command which will handle cloning the repo:

```bash
➜ go get -u -v github.com/mprambadi/golang-echo-realworld-example-app
```

Switch to the repo folder

```bash
➜ cd $GOPATH/src/github.com/mprambadi/golang-echo-realworld-example-app
```
